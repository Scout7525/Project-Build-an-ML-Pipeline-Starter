...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = "Name of artificat to do processing on",
        required = True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type = str,
        help = "Description of preprocessed data",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help = "Min price considered for prediction column",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help = "Max price considered for prediction column",
        required = True
    )
